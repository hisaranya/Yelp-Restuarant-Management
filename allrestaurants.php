  ...
  <div class="main">
    <div class="container">
        ...
        //check if it's a search result
            ...
            if (!mysql_select_db('Restaurant', $connection)) {
      ...
      order by avg(res.rating) DESC) WHERE rownum<=20";
			...
			//$stid = mysql_parse($connection, $sql);
			...
			for($i=0; $i < $nrows; $i++){
			    ...
			    $rname = mysql_result($result,$i,"RNAME");
			    $street = mysql_result($result,$i,"STREET");
			    $city = mysql_result($result,$i,"CITY");
			    $state = mysql_result($result,$i,"STATE");
			    $zipcode = mysql_result($result,$i,"ZIPCODE");
			    $pricerange = mysql_result($result,$i,"PRICERANGE");
			    $cuisinename = mysql_result($result,$i,"CUISINENAME");
			    $rating = mysql_result($result,$i,"RATING");
			    $reviews = mysql_result($result,$i,"REVIEWS");
      ...
      order by avg(res.rating) DESC";
			...
			//echo $sql;
			//$stid1 = mysql_parse($connection, $sql);
			//mysql_execute($stid1);
			$result = mysql_query($sql, $connection);
			$nrows = mysql_numrows($result);
			...
			//$nrows = mysql_fetch_all($stid1, $res);
			/*
				pages
			*/
